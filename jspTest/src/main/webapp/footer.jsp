    ...
    <div class="container ">
        <form action="#" class="form-footer">
            <div class="form-group">
                <h1 class="display-5">Online Store Copylight</h1>
                <p class="text-muted text-weight-bolder">주문 문의</p>
        ...
        <div class="login-card-social">
                <div class="text-muted text-weight-bolder"><p>간편 아이디로 로그인하기</p></div>
